...
C'est le [Sandre](http://www.sandre.eaufrance.fr/) (Service d'administration nationale des données et référentiels sur l'eau) qui propose différents flux. Pour l'accès au cours d'eau (BD Topage), le service WFS est le suivant : [https://services.sandre.eaufrance.fr/geo/topage?](https://services.sandre.eaufrance.fr/geo/topage?)
